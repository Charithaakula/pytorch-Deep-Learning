...
In this section, we discussed regularized latent variable EBMs in detail covering concepts of conditional and unconditional versions of these models. We then discussed the algorithms of ISTA, FISTA and LISTA and look at examples of sparse coding and filters learned from convolutional sparse encoders. We also talked about Variational Auto-Encoders and the underlying concepts involved. Finally, we discussed about Joint Embedding Methods and Visual Representation Learning
